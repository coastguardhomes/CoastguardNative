...
const translations = {
  ...
  fr: {
    ...
    trabajosExtrasDisponibles: "Travaux extras disponibles !",
    tienes: "Vous avez",
    trabajosRegistrados: "travaux ou rapports extras enregistrés.",
    ...
    facturaCreadaCorrectamente: "Factura créée avec succès",
    cliente: "Client",
    ...
    resumenCorreoSub: "Recevez rapports et factures par e-mail.",
    alertasCriticasTitulo: "Alertes d'incidents critiques",
    alertasCriticasSub: "Avis urgents d'incidents graves.",
    ...
    ultimoCambioContrasena: "Dernier changement il y a plus de 30 jours",
    cambiar: "Modifier",
    ...
    errorCargandoContratos: "Erreur de chargement des contrats.",
    errorInesperadoContratos: "Erreur inattendue.",
    ...
    pdfCondiciones: "CONDITIONS",
    pdfCondicionesTexto: "Le prestataire s'engage à effectuer les inspections et services...",
    ...
    errorSubirPdfStorage: "Erreur lors du téléchargement du PDF : ",
    errorGenerarPdf: "Erreur lors de la génération du PDF : ",
    pdfCargando: "Chargement du PDF...",
    pdfNoGenerado: "Aucun fichier PDF généré pour ce contrat.",
    ...
    total: "Total",
    verPdf: "Voir le PDF",
    noPdfGenerado: "Aucun PDF généré pour cette facture.",
    ...
    errorCargarDatos: "Erreur lors du chargement des données.",
    ...
    informeNoEncontradoPermisos: "Rapport introuvable ou permissions insuffisantes.",
    errorConexionCargarInformacion: "Erreur de connexion.",
    confirmarBorrarInforme: "Êtes-vous sûr de vouloir supprimer ce rapport ?",
    ...
    noHayFotografiasInforme: "Aucune photo jointe.",
