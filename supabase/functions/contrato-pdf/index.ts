...
serve(async (req) => {
  ...
  try {
    ...
    // Consulta original con la relación intacta
    ...
    const selloEmpresa = contrato.sello_url || "";
...
<body>
  ...
  <div class="signatures-container">
    <div class="sig-box">
      ...
      ${selloEmpresa ? `<img src="${selloEmpresa}" class="stamp-img" alt="Sello Empresa" />` : `<div style="font-size:8pt; color:#94a3b8; margin:auto;">[Sello no configurado]</div>`}
    ...
    if (updateError) {
      return new Response(
        JSON.stringify({ error: "Error guardando el contenido del contrato", detail: updateError.message }),
